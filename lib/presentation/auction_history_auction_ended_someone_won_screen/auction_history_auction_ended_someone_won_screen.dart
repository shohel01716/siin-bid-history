...
class AuctionHistoryAuctionEndedSomeoneWonScreen extends StatelessWidget {
  const AuctionHistoryAuctionEndedSomeoneWonScreen({Key? key})
      : super(key: key);
                          ...
                          child: Padding(
                              ...
                              child: Column(children: [
                                ...
                                Padding(
                                    ...
                                    child: _buildAuctionUserFrame3(context,
                                        userName: "User01",
                                        date: "20 Oct 2023",
                                        time: "12:45PM",
  ...
  /// Section Widget
  Widget _buildAuctionFrame(BuildContext context) {
  ...
  Widget _buildTwelve(BuildContext context) {
    return Column(children: [
      ...
      SizedBox(height: 8.v),
      _buildAuctionUserFrame(context,
          userName: "You",
          date: "20 Oct 2023",
          time: "12:45PM",
          bdCounter: "BD 200.00"),
      _buildAuctionUserFrame1(context,
          userName: "User01",
          date: "20 Oct 2023",
          time: "12:45PM",
          birthdayCounter: "BD 200.00"),
      _buildAuctionUserFrame2(context,
          userOne: "User01",
          date: "20 Oct 2023",
          time: "12:45PM",
          bdCounter: "BD 200.00"),
  ...
  /// Common widget
  Widget _buildAuctionUserFrame1(
    BuildContext context, {
    required String userName,
    required String date,
    required String time,
  ...
  /// Common widget
  Widget _buildAuctionUserFrame2(
    BuildContext context, {
  ...
  /// Common widget
  Widget _buildAuctionUserFrame3(
    BuildContext context, {
    required String userName,
    required String date,
    required String time,
